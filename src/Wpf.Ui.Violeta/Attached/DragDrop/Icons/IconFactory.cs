...
namespace Wpf.Ui.Violeta.Attached.DragDrop.Icons;
...
public static class IconFactory
{
    ...
    {
        var uri = new Uri($@"pack://application:,,,/Wpf.Ui.Violeta;component/Attached/DragDrop/Icons/{iconName}", UriKind.RelativeOrAbsolute);
    ...
    public static Cursor CreateCursor(double rx, double ry, SolidColorBrush brush, Pen pen)
    {
...

        {
            ...
            ms.Write(BitConverter.GetBytes((short)22), 0, 4); //Specifies the offset of BMP or PNG data from the beginning of the ICO/CUR file
        }

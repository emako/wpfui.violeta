...
public class DefaultDropHandler : IDropTarget
{
    ...
    {
        _ = dropInfo ?? throw new ArgumentNullException(nameof(dropInfo));
    ...
    protected static void Move(IList list, int sourceIndex, int destinationIndex)
    {
        ...
        if (sourceIndex != destinationIndex)
        {
            ...
            _ = method?.Invoke(list, [sourceIndex, destinationIndex]);
        }
    }
    ...
    protected static bool TestCompatibleTypes(IEnumerable target, object data)
    {
        ...
        static bool InterfaceFilter(Type t, object o)

...
public static class VisualTreeExtensions
{
    ...
    {
        _ = itemsControl ?? throw new ArgumentNullException(nameof(itemsControl));
        _ = itemContainerSearchType ?? throw new ArgumentNullException(nameof(itemContainerSearchType));

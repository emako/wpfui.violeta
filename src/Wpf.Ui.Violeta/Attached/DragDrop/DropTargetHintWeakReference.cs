...
/// </summary>
internal sealed class DropTargetHintWeakReference(UIElement dropTarget) : IDisposable
{
    private readonly WeakReference<UIElement> _dropTarget = new(dropTarget);
    private DropTargetHintAdorner dropTargetHintAdorner = null!;
    ...
    public DropTargetHintAdorner DropTargetHintAdorner
    {
        ...
        set
        {
            this.dropTargetHintAdorner?.Detach();

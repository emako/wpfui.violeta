...
internal class ResourceAccessor
{
    ...
    public string GetLocalizedStringResource(string resourceName)
    {
        try
        {
            // Prefer Violeta's SH localization pipeline first.
            // This keeps language switching behavior consistent with the rest of the library.
            string? sharedValue = SH.ResourceManager.GetString(resourceName, SH.Culture);

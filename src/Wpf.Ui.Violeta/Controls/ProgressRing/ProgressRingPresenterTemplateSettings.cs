...
/// <summary>
/// Provides calculated path geometry values for <see cref="Wpf.Ui.Violeta.Controls.ProgressRingPresenter"/>.
...
public sealed class ProgressRingPresenterTemplateSettings : DependencyObject
{
    ...
    public static readonly DependencyProperty OutlinePathProperty =
        OutlinePathPropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty RingPathProperty =
        RingPathPropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty RingArcIsLargeArcProperty =
        RingArcIsLargeArcPropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty RingArcPointProperty =
        RingArcPointPropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty RingArcSizeProperty =
        RingArcSizePropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty OutlineFigureStartPointProperty =
        OutlineFigureStartPointPropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty OutlineArcSizeProperty =
        OutlineArcSizePropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty OutlineArcPointProperty =
        OutlineArcPointPropertyKey.DependencyProperty;
    ...
    public static readonly DependencyProperty RingFigureStartPointProperty =
        RingFigureStartPointPropertyKey.DependencyProperty;

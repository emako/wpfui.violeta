...
public sealed partial class TextRender
{
    ...
    private sealed class TextRenderState : IDisposable
    {
        ...
        private CharacterLayout[] _characters = null!;
        private double[] _resolvedX = null!;
        private double[] _resolvedY = null!;
        private double[] _resolvedDx = null!;
        private double[] _resolvedDy = null!;
        private double[] _resolvedRotate = null!;
        private int[] _xBaseIndicies = null!;
        private int[] _yBaseIndicies = null!;
        ...
        private static readonly Regex _trimmedWhitespace = new(@"(?<Start>^\s*).*(?<End>\s*$)", RegexOptions.Compiled | RegexOptions.Singleline);

        [SuppressMessage("Performance", "SYSLIB1045:Convert to 'GeneratedRegexAttribute'.")]
        private static readonly Regex _lineStarts = new(@"^ *\S", RegexOptions.Compiled | RegexOptions.Multiline);

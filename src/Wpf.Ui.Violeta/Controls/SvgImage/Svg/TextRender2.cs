...
public class TextRender2 : TextRenderBase
{
    ...
    private static Geometry BuildGlyphRun(TextStyle textStyle, string text, double x, double y, ref double totalwidth)
    {
        ...
        Typeface font = new(new FontFamily(textStyle.FontFamily),
            textStyle.Fontstyle,
        ...
        if (textStyle.TextDecoration != null)
        {
            ...
            Rect bounds = new(gp.Bounds.Left, decorationPos, gp.Bounds.Width, decorationThickness);

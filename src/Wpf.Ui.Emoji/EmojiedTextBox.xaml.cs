...
/// <summary>
/// The Wpf.Ui.Emoji.EmojiedTextBox class inherits from the WPF TextBox, but it actually uses an
/// Wpf.Ui.Emoji.EmojiedRichTextBox internally, through the template system. This is because only

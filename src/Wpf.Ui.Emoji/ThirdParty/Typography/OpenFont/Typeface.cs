...
public partial class Typeface
{
    ...
    private CFF.Cff1FontSet _cff1FontSet;
    ...
    {
        return CmapTable.GetGlyphIndex(codepoint, 0, out _);
    }
    ...
    private MathGlyphs.MathGlyphInfo[] _mathGlyphInfos;
...
public readonly struct GlyphNameMap(ushort glyphIndex, string glyphName)
{
    public readonly ushort glyphIndex = glyphIndex;
    public readonly string glyphName = glyphName;
}
